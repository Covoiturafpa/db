...
\du
CREATE user jfrbnsrgohior WITH LOGIN PASSWORD 'test';
\du
ALTER SCHEMA heroku_ext OWNER TO jfrbnsrgohior;
...
ALTER TYPE heroku_ext.car_type_name OWNER TO jfrbnsrgohior;
...
ALTER TYPE heroku_ext.day_name OWNER TO jfrbnsrgohior;
...
ALTER TYPE heroku_ext.notification_type OWNER TO jfrbnsrgohior;
...
ALTER TYPE heroku_ext.status_type OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.car OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.car_id_car_seq OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.car_type OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.car_type_id_car_type_seq OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.centre OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.centre_id_centre_seq OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.city OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.city_id_city_seq OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.day_timetable OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.day_timetable_id_day_timetable_seq OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.day_week OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.day_week_id_day_week_seq OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.destination OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.destination_id_destination_seq OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.employee OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.formation OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.formation_id_formation_seq OWNER TO jfrbnsrgohior;
...
ALTER TABLE heroku_ext.fuel OWNER TO jfrbnsrgohior;
