...
\du
ALTER SCHEMA heroku_ext OWNER TO adminTest;
...
ALTER TYPE heroku_ext.car_type_name OWNER TO adminTest;
ALTER TYPE heroku_ext.day_name OWNER TO adminTest;
ALTER TYPE heroku_ext.notification_type OWNER TO adminTest;
ALTER TYPE heroku_ext.status_type OWNER TO adminTest;
...
ALTER TABLE heroku_ext.car OWNER TO adminTest;
ALTER TABLE heroku_ext.car_id_car_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.car_type OWNER TO adminTest;
ALTER TABLE heroku_ext.car_type_id_car_type_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.centre OWNER TO adminTest;
ALTER TABLE heroku_ext.centre_id_centre_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.city OWNER TO adminTest;
ALTER TABLE heroku_ext.city_id_city_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.day_timetable OWNER TO adminTest;
ALTER TABLE heroku_ext.day_timetable_id_day_timetable_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.day_week OWNER TO adminTest;
ALTER TABLE heroku_ext.day_week_id_day_week_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.destination OWNER TO adminTest;
ALTER TABLE heroku_ext.destination_id_destination_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.employee OWNER TO adminTest;
ALTER TABLE heroku_ext.formation OWNER TO adminTest;
ALTER TABLE heroku_ext.formation_id_formation_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.fuel OWNER TO adminTest;
ALTER TABLE heroku_ext.fuel_id_fuel_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.notification OWNER TO adminTest;
ALTER TABLE heroku_ext.notification_id_notification_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.one_time OWNER TO adminTest;
ALTER TABLE heroku_ext.partner OWNER TO adminTest;
ALTER TABLE heroku_ext.partner_id_partner_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.person OWNER TO adminTest;
ALTER TABLE heroku_ext.person_id_person_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.recurring OWNER TO adminTest;
ALTER TABLE heroku_ext.recurring_days OWNER TO adminTest;
ALTER TABLE heroku_ext.ride OWNER TO adminTest;
ALTER TABLE heroku_ext.ride_id_ride_seq OWNER TO adminTest;
...
ALTER TABLE heroku_ext.ride_passenger OWNER TO adminTest;
ALTER TABLE heroku_ext.teacher_of OWNER TO adminTest;
ALTER TABLE heroku_ext.trainee OWNER TO adminTest;
...
INSERT INTO heroku_ext.centre VALUES (28, 'Centre Afpa de Dunkerque', '407 Av. de la Gironde', 51.00609, 2.33884, '+33972723936', true);
